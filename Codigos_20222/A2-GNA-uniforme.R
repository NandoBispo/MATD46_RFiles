...
# segue uma uniforme
# Visualização da distribuição acumulada empírica da sequência gerada (linha preta) com uma distribuição acumulada de uma uniforme gerada pela fun??o punif() (linha vermelha - usada como referência).
